...
OhdsiRTools::checkUsagePackage("Covid19SeverityPrediction1")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/Covid19SeverityPrediction1.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Covid19SeverityPrediction1.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "Covid19SeverityPrediction1")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("Covid19SeverityPrediction1")
