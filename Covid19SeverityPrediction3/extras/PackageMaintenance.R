...
OhdsiRTools::checkUsagePackage("Covid19SeverityPrediction3")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/Covid19SeverityPrediction3.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Covid19SeverityPrediction3.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "Covid19SeverityPrediction3")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("Covid19SeverityPrediction3")
